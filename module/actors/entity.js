export default class NaheulbeukActor extends Actor {
    ...
    prepareData() {
        ...
        const prepareNPC = () => {
            this.data.data.abilities.HP.base =1;
        }
    

        const prepareCharacters = () => {
            console.log("this.data",this.data)
            console.log("this.data.data",this.data.data)
            console.log("this.data.data.abilities",this.data.data.abilities)
            console.log("this.data.data.abilities.ADR",this.data.data.abilities.ADR)
            console.log("this.data.data.abilities.ADR.bonus",this.data.data.abilities.ADR.bonus)
            this.data.data.ADR.abilities.bonus = 0;
